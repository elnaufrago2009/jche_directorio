...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { admin_id: @comentario.admin_id, content: @comentario.content, tiked_id: @comentario.tiked_id, user_id: @comentario.user_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { admin_id: @comentario.admin_id, content: @comentario.content, tiked_id: @comentario.tiked_id, user_id: @comentario.user_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
